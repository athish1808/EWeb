    ...
    <div className='half'>
      ...
      {/******* Signup Form *********** */}
        ...
        <div className='signupform'>
          ...
          {submitted ?
          <Alert  variant='success' style={{width:'20%'}}>{`Success,Thanks for registering in FashionWorld ${values.firstname} Click Login to continue`} </Alert>
         :null}
         <div style={{marginTop:'45px'}}>
          <form id='form' onSubmit={handleSubmit}> 
           ...
           <div>
            <h2 style={{fontFamily:'cursive',color:'grey',marginTop:'10px'}}>Do you have a account already?<p className='login' onClick={handleLogin}>LOGIN</p></h2>
            </div>
          </form>
          </div>
        </div>
